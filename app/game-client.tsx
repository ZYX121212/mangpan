...
import { INITIAL_BARS, INITIAL_CASH, ORDER_ALLOCATIONS, clamp, lotSizeFor, orderQuantity, type MarketKind, type OrderAllocation, type ReplayAction } from "./game-config";
...
export default function GameClient({ initialChallenges }: { initialChallenges: InitialChallenges }) {
  ...
  const availableDays = Math.max(0, normalized.length - INITIAL_BARS), remainingDays = Math.max(0, availableDays - advancedDays);
